      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="forms/form-control.html#disabled">
            ...
            <br />
            <CFormInput type="text" placeholder="Disabled readonly input" aria-label="Disabled input example" disabled
              readonly />
            <br />
          </DocsExample>
        </CCardBody>
          ...
          <DocsExample href="forms/form-control.html#readonly-plain-text">
            <CForm class="row g-3">
              ...
              <div class="col-auto">
                ...
                <CFormTextarea id="exampleFormControlTextarea1" label="Example textarea" rows="3"
